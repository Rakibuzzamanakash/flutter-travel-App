...
class _NavAddLastStepState extends State<NavAddLastStep> {
    ...
    try{
      if(multipleImages != null){
        ...
        for(int i = 0 ; i<multipleImages!.length; i += 1){
          ...
          UploadTask uploadTask = storage.ref('${authCredential!.email}').
          child(multipleImages![i].name).putFile(imageFile);
  ...
  uploadToDB(){
   if(imageUrls.isNotEmpty){
     CollectionReference data = FirebaseFirestore.instance.collection('all-data');
